...
var drawer12s = require('./drawer-12s-ClgJ3fRT.cjs');
...
var progress12s = require('./progress-12s-C5KmUjfL.cjs');
var collapsible12s = require('./collapsible-12s-BPMYDSPW.cjs');
...
const Button = /*#__PURE__*/ React__namespace.forwardRef((_param, ref)=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(Comp, _extends._({
        className: drawer12s.cn(buttonVariants({
            variant,
            size,
            className
        })),
...
const CodeBlock = /*#__PURE__*/ React.memo((props)=>{
    ...
    React.useEffect(()=>{
        if (codeRef.current && codeRef.current.dataset.highlighted !== 'yes') {
            hljs__default.default.highlightElement(codeRef.current);
        }
    }, [
        language,
        value
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs("div", {
        className: drawer12s.cn('codeblock border-border relative w-full rounded-lg border bg-[#fafafa] py-2', className),
        children: [
            showHeader && /*#__PURE__*/ jsxRuntime.jsxs("div", {
                className: drawer12s.cn('flex w-full items-center justify-between px-4', headerClassName),
                children: [
                    ...
                    /*#__PURE__*/ jsxRuntime.jsxs("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsxRuntime.jsxs(Button, {
                                ...
                                className: "size-8",
                                children: [
                                    isCopied ? /*#__PURE__*/ jsxRuntime.jsx(lucideReact.Check, {
                                        className: "size-4"
            ...
            /*#__PURE__*/ jsxRuntime.jsx("pre", {
                children: /*#__PURE__*/ jsxRuntime.jsx("code", {
                    ref: codeRef,
                    className: drawer12s.cn(`language-${language} rounded-lg border border-none font-mono`, codeClassName),
                    children: value
                })
            })
        ]
...
const PDFViewer = /*#__PURE__*/ React.lazy(()=>import('@llamaindex/pdf-viewer').then((m)=>({
            default: m.PDFViewer
        })));
const PdfFocusProvider = /*#__PURE__*/ React.lazy(()=>import('@llamaindex/pdf-viewer').then((m)=>({
            default: m.PdfFocusProvider
        })));
function PdfDialog(props) {
    return /*#__PURE__*/ jsxRuntime.jsxs(drawer12s.Drawer, {
        direction: "left",
        children: [
            /*#__PURE__*/ jsxRuntime.jsx(drawer12s.DrawerTrigger, {
                asChild: true,
                children: props.trigger
            }),
            /*#__PURE__*/ jsxRuntime.jsxs(drawer12s.DrawerContent, {
                className: "mt-24 h-full max-h-[96%] w-full md:w-3/5",
                children: [
                    /*#__PURE__*/ jsxRuntime.jsxs(drawer12s.DrawerHeader, {
                        className: "flex flex-col gap-4 sm:flex-row sm:justify-between",
                        children: [
                            /*#__PURE__*/ jsxRuntime.jsxs("div", {
                                className: "space-y-2",
                                children: [
                                    /*#__PURE__*/ jsxRuntime.jsx(drawer12s.DrawerTitle, {
                                        children: "PDF Content"
                                    }),
                                    /*#__PURE__*/ jsxRuntime.jsxs(drawer12s.DrawerDescription, {
                                        className: "break-all",
                                        children: [
                                            "File URL:",
                                            ' ',
                            ...
                            /*#__PURE__*/ jsxRuntime.jsx(drawer12s.DrawerClose, {
                                asChild: true,
                    ...
                    /*#__PURE__*/ jsxRuntime.jsx("div", {
                        className: "m-4",
                        children: /*#__PURE__*/ jsxRuntime.jsx(PdfFocusProvider, {
                            children: /*#__PURE__*/ jsxRuntime.jsx(PDFViewer, {
                                file: {
                                    id: props.documentId,
                                    url: props.url
                                }
...
function SourceNumberButton({ index, className }) {
    return /*#__PURE__*/ jsxRuntime.jsx("span", {
        className: drawer12s.cn('inline-flex h-5 w-5 items-center justify-center rounded-full bg-gray-100 text-xs text-black', className),
        children: index + 1
    });
}
...
const SheetIcon = ()=>/*#__PURE__*/ jsxRuntime.jsxs("svg", {
        width: "49px",
        height: "67px",
        viewBox: "0 0 49 67",
        version: "1.1",
...
function DocumentInfo({ document, className, onRemove, startIndex = 0 }) {
    ...
    const DocumentDetail = /*#__PURE__*/ jsxRuntime.jsxs("div", {
        className: `bg-secondary rounded-lg p-2 ${className}`,
        children: [
            /*#__PURE__*/ jsxRuntime.jsx(DocumentPreviewCard, {
            ...
            /*#__PURE__*/ jsxRuntime.jsx("div", {
                ...
                children: sources.map((node, index)=>/*#__PURE__*/ jsxRuntime.jsx("div", {
                        children: /*#__PURE__*/ jsxRuntime.jsx(SourceInfo, {
                            node: node,
    ...
    if (url.endsWith('.pdf')) {
        ...
        return /*#__PURE__*/ jsxRuntime.jsx(PdfDialog, {
            documentId: url,
            url: url,
...
function SourceInfo({ node, index }) {
    if (!node) return /*#__PURE__*/ jsxRuntime.jsx(SourceNumberButton, {
        index: index
    });
    return /*#__PURE__*/ jsxRuntime.jsxs(reactHoverCard.HoverCard, {
        children: [
            /*#__PURE__*/ jsxRuntime.jsx(reactHoverCard.HoverCardTrigger, {
                className: "cursor-default",
                onClick: (e)=>{
                    e.preventDefault();
                    e.stopPropagation();
                },
                children: /*#__PURE__*/ jsxRuntime.jsx(SourceNumberButton, {
                    index: index,
                    className: "hover:bg-primary hover:text-white"
                })
            }),
            /*#__PURE__*/ jsxRuntime.jsx(reactHoverCard.HoverCardContent, {
                className: "w-[400px] bg-white p-4",
                children: /*#__PURE__*/ jsxRuntime.jsx(NodeInfo, {
                    nodeInfo: node
                })
            })
        ]
        ...
        children: [
            /*#__PURE__*/ jsxRuntime.jsxs("div", {
                ...
                children: [
                    ...
                    nodeInfo.text && /*#__PURE__*/ jsxRuntime.jsx(Button, {
                        onClick: (e)=>{
                            e.stopPropagation();
            ...
            nodeInfo.text && /*#__PURE__*/ jsxRuntime.jsxs("pre", {
...
const FileIconMap = {
    csv: /*#__PURE__*/ jsxRuntime.jsx(SheetIcon, {}),
    pdf: /*#__PURE__*/ jsxRuntime.jsx(PDFIcon, {}),
    docx: /*#__PURE__*/ jsxRuntime.jsx(DocxIcon, {}),
    txt: /*#__PURE__*/ jsxRuntime.jsx(TxtIcon, {})
};
function DocumentPreviewCard(props) {
    const { onRemove, file, className } = props;
    var _FileIconMap_file_type;
    return /*#__PURE__*/ jsxRuntime.jsxs("div", {
        className: drawer12s.cn('bg-secondary relative w-60 max-w-60 rounded-lg p-2 text-sm', className),
        children: [
            /*#__PURE__*/ jsxRuntime.jsxs("div", {
                ...
                children: [
                    /*#__PURE__*/ jsxRuntime.jsx("div", {
                        ...
                        children: (_FileIconMap_file_type = FileIconMap[file.type]) != null ? _FileIconMap_file_type : /*#__PURE__*/ jsxRuntime.jsx(lucideReact.FileIcon, {})
                    }),
                    /*#__PURE__*/ jsxRuntime.jsxs("div", {
                        ...
                        children: [
                            ...
                            file.type && /*#__PURE__*/ jsxRuntime.jsx("div", {
            ...
            onRemove && /*#__PURE__*/ jsxRuntime.jsx("div", {
                className: drawer12s.cn('absolute -right-2 -top-2 z-10 h-6 w-6 rounded-full bg-gray-500 text-white'),
                children: /*#__PURE__*/ jsxRuntime.jsx(lucideReact.XCircleIcon, {
...
function Citation({ index }) {
    return /*#__PURE__*/ jsxRuntime.jsx(SourceNumberButton, {
        index: index
    });
}
...
const MemoizedReactMarkdown = /*#__PURE__*/ React.memo(ReactMarkdown__default.default, (prevProps, nextProps)=>prevProps.children === nextProps.children && prevProps.className === nextProps.className);
...
function Markdown({ content, sources, backend, citationComponent: CitationComponent, className: customClassName, languageRenderers, annotationRenderers }) {
    ...
    return /*#__PURE__*/ jsxRuntime.jsx("div", {
        children: /*#__PURE__*/ jsxRuntime.jsx(MemoizedReactMarkdown, {
            className: drawer12s.cn('prose dark:prose-invert prose-p:leading-relaxed prose-pre:p-0 custom-markdown break-words', customClassName),
            remarkPlugins: [
            ...
            components: {
                ...
                code (_param) {
                    var { inline, className, children } = _param, props = _object_without_properties_loose._(_param, [
                        "inline",
                        "className",
                        "children"
                    ]);
                    ...
                    if (annotation) {
                        ...
                        if (annotationRenderers == null ? void 0 : annotationRenderers[annotation.type]) {
                            ...
                            return /*#__PURE__*/ jsxRuntime.jsx("div", {
                                ...
                                children: /*#__PURE__*/ jsxRuntime.jsx(CustomRenderer, {
                    ...
                    if (inline) {
                        return /*#__PURE__*/ jsxRuntime.jsx("code", _extends._({
                            className: className
                        }, props, {
                            children: children
                        }));
                    ...
                    if (languageRenderers == null ? void 0 : languageRenderers[language]) {
                        ...
                        return /*#__PURE__*/ jsxRuntime.jsx(CustomRenderer, {
                            code: codeValue,
                            className: "mb-2"
                        });
                    }
                    return /*#__PURE__*/ jsxRuntime.jsx(CodeBlock, _extends._({
                        language: language,
                        value: codeValue,
                        className: "mb-2"
                    }, props), Math.random());
                ...
                a ({ href, children }) {
                    ...
                    if (href == null ? void 0 : href.startsWith(`${backend}/api/files`)) {
                        ...
                        if (fileExtension) {
                            return /*#__PURE__*/ jsxRuntime.jsx(DocumentInfo, {
                                document: {
                    ...
                    if (Array.isArray(children) && typeof children[0] === 'string' && (children[0].startsWith('citation:') || (href == null ? void 0 : href.startsWith('citation:')))) {
                        ...
                        if (nodeIndex !== undefined && nodeIndex > -1 && sourceNode) {
                            return CitationComponent ? /*#__PURE__*/ jsxRuntime.jsx(CitationComponent, {
                                index: nodeIndex,
                                node: sourceNode
                            }) : /*#__PURE__*/ jsxRuntime.jsx(Citation, {
                                index: nodeIndex,
                                node: sourceNode
                            });
                        }
...
const AgentIcons = {
    bot: lucideReact.icons.Bot,
    researcher: lucideReact.icons.ScanSearch,
    writer: lucideReact.icons.PenLine,
    reviewer: lucideReact.icons.MessageCircle,
    publisher: lucideReact.icons.BookCheck
};
function ChatAgentEvents({ data, isFinished, isLast }) {
    const events = React.useMemo(()=>mergeAdjacentEvents(data), [
        data
    ]);
    return /*#__PURE__*/ jsxRuntime.jsx("div", {
        className: "pl-2",
        children: /*#__PURE__*/ jsxRuntime.jsx("div", {
            ...
            children: events.map((eventItem, index)=>/*#__PURE__*/ jsxRuntime.jsx(AgentEventContent, {
                    event: eventItem,
                    isLast: isLast,
...
function TextContent({ agent, step }) {
    const { displayText, showMore } = React.useMemo(()=>({
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs("div", {
        ...
        children: [
            !showMore && /*#__PURE__*/ jsxRuntime.jsx("span", {
                children: step.text
            }),
            showMore && /*#__PURE__*/ jsxRuntime.jsxs("div", {
                children: [
                    ...
                    /*#__PURE__*/ jsxRuntime.jsx(AgentEventDialog, {
                        content: step.text,
                        title: `Agent "${agent}"`,
...
function ProgressContent({ step }) {
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs("div", {
        ...
        children: [
            step.text && /*#__PURE__*/ jsxRuntime.jsx("p", {
                className: "text-muted-foreground text-sm",
                children: step.text
            }),
            /*#__PURE__*/ jsxRuntime.jsx(progress12s.Progress, {
                value: progressValue,
...
function AgentEventContent({ event, isLast, isFinished }) {
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs("div", {
        ...
        children: [
            /*#__PURE__*/ jsxRuntime.jsxs("div", {
                ...
                children: [
                    /*#__PURE__*/ jsxRuntime.jsxs("div", {
                        className: "relative",
                        children: [
                            isLast && !isFinished && /*#__PURE__*/ jsxRuntime.jsx("div", {
            ...
            textSteps.length > 0 && /*#__PURE__*/ jsxRuntime.jsxs("div", {
                className: "flex-1",
                children: [
                    /*#__PURE__*/ jsxRuntime.jsx("ul", {
                        className: "list-decimal space-y-2",
                        children: textSteps.map((step, index)=>/*#__PURE__*/ jsxRuntime.jsx("li", {
                                children: /*#__PURE__*/ jsxRuntime.jsx(TextContent, {
                                    agent: agent,
                                    step: step
                                })
                            }, index))
                    }),
                    lastProgressStep && !isFinished && /*#__PURE__*/ jsxRuntime.jsx(ProgressContent, {
                ...
                children: [
                    /*#__PURE__*/ jsxRuntime.jsxs(drawer12s.DrawerHeader, {
                        ...
                        children: [
                            /*#__PURE__*/ jsxRuntime.jsx("div", {
                                className: "space-y-2",
                                children: /*#__PURE__*/ jsxRuntime.jsx(drawer12s.DrawerTitle, {
    ...
    for (const event of events){
        ...
        if (lastMergedEvent && lastMergedEvent.agent === event.agent) {
            ...
            mergedEvents.push({
                ...
                icon: (_AgentIcons_event_agent_toLowerCase = AgentIcons[event.agent.toLowerCase()]) != null ? _AgentIcons_event_agent_toLowerCase : lucideReact.icons.Bot
            });
        }
    }
    return mergedEvents;
...
function ChatEvents({ data, showLoading }) {
    ...
    const EventIcon = isOpen ? /*#__PURE__*/ jsxRuntime.jsx(lucideReact.ChevronDown, {
        className: "h-4 w-4"
    ...
    return /*#__PURE__*/ jsxRuntime.jsx("div", {
        ...
        children: /*#__PURE__*/ jsxRuntime.jsxs(collapsible12s.Collapsible, {
            open: isOpen,
            onOpenChange: setIsOpen,
            children: [
                /*#__PURE__*/ jsxRuntime.jsx(collapsible12s.CollapsibleTrigger, {
                    asChild: true,
                    children: /*#__PURE__*/ jsxRuntime.jsxs(Button, {
                        variant: "secondary",
                        className: "space-x-2",
                        children: [
                            showLoading ? /*#__PURE__*/ jsxRuntime.jsx(lucideReact.Loader2, {
                ...
                /*#__PURE__*/ jsxRuntime.jsx(collapsible12s.CollapsibleContent, {
                    asChild: true,
                    children: /*#__PURE__*/ jsxRuntime.jsx("div", {
                        className: "mt-4 space-y-2 text-sm",
                        children: data.map((eventItem, index)=>/*#__PURE__*/ jsxRuntime.jsx("div", {
                                className: "whitespace-break-spaces",
...
function ChatFiles({ data, className }) {
    ...
    return /*#__PURE__*/ jsxRuntime.jsx("div", {
        className: drawer12s.cn('flex items-center gap-2', className),
        children: data.files.map((file)=>/*#__PURE__*/ jsxRuntime.jsx(DocumentInfo, {
                document: {
                    url: file.url,
                    sources: []
                },
...
function SuggestedQuestions({ questions, append, requestData }) {
    ...
    return showQuestions && /*#__PURE__*/ jsxRuntime.jsx("div", {
        className: "flex flex-col space-y-2",
        children: questions.map((question, index)=>/*#__PURE__*/ jsxRuntime.jsxs("a", {
                onClick: ()=>{
                    append({
                        role: 'user',
                        content: question
...
function StarterQuestions(props) {
    return /*#__PURE__*/ jsxRuntime.jsx("div", {
        className: drawer12s.cn('w-full', props.className),
        children: /*#__PURE__*/ jsxRuntime.jsx("div", {
            className: "grid grid-cols-2 gap-3",
            children: props.questions.map((question, i)=>/*#__PURE__*/ jsxRuntime.jsx(Button, {
                    variant: "outline",
...
function ImagePreview({ url, onRemove }) {
    return /*#__PURE__*/ jsxRuntime.jsxs("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsx("div", {
                className: drawer12s.cn('absolute -right-2 -top-2 z-10 hidden h-6 w-6 rounded-full bg-gray-500 text-white group-hover:block'),
                children: /*#__PURE__*/ jsxRuntime.jsx(lucideReact.XCircleIcon, {
                    className: "h-6 w-6 rounded-full bg-gray-500 text-white",
                    onClick: onRemove
                })
...
function FileUploader({ config, onFileUpload, onFileError, className }) {
    ...
    const [remainingFiles, setRemainingFiles] = React.useState(0);
    ...
    const onFileChange = (e)=>_async_to_generator._(function*() {
    ...
    const handleUpload = (files)=>_async_to_generator._(function*() {
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs("div", {
        className: drawer12s.cn('self-stretch', className),
        children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsx("label", {
                ...
                children: uploading ? /*#__PURE__*/ jsxRuntime.jsxs("div", {
                    className: "relative flex h-full w-full items-center justify-center",
                    children: [
                        /*#__PURE__*/ jsxRuntime.jsx(lucideReact.Loader2, {
                            className: "absolute h-6 w-6 animate-spin"
                        }),
                        remainingFiles > 0 && /*#__PURE__*/ jsxRuntime.jsx("span", {
                            className: "absolute inset-0 flex items-center justify-center text-xs",
                            children: remainingFiles
                        })
                    ]
                }) : /*#__PURE__*/ jsxRuntime.jsx(lucideReact.Paperclip, {
...
function CodeEditor({ code, onChange, className, language = 'javascript' }) {
    return /*#__PURE__*/ jsxRuntime.jsx(CodeMirror__default.default, {
        className: drawer12s.cn('h-full text-[14px]', className),
        value: code,
        extensions: [
            getLanguageExtension(language)
        ],
        onChange: onChange,
        theme: codemirrorThemeGithub.githubLight
    });
}
...
function DocumentEditor({ content, onChange, className, showToolbar = true }) {
    ...
    if (showToolbar) {
        plugins.push(editor.toolbarPlugin({
            toolbarContents: ()=>/*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                    children: [
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(editor.MDXEditor, {
        className: className,
        onChange: onChange,
        markdown: content,
        plugins: plugins,
...
exports.ChatAgentEvents = ChatAgentEvents;
exports.ChatEvents = ChatEvents;
exports.ChatFiles = ChatFiles;
exports.ChatImage = ChatImage;
exports.ChatSources = ChatSources;
...
exports.PdfDialog = PdfDialog;
exports.StarterQuestions = StarterQuestions;
exports.SuggestedQuestions = SuggestedQuestions;
exports.fileExtensionToEditorLang = fileExtensionToEditorLang;
